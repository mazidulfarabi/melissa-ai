...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const localResponses = {
      ...
      // Name questions
      'what is your name': [
        "আমি সবুজ সাথী, আপনার গাছের যত্নের AI সহায়ক! দেখা করে ভালো লাগছে! 😊",
        "আমার নাম সবুজ সাথী! আপনার গাছের যত্নে সাহায্য করতে এখানে আছি! 👋",
        "আমি সবুজ সাথী! গাছের রোগ নির্ণয় এবং যত্নের পরামর্শ দিতে পারি! 😄"
      ],
      'whats your name': [
        "আমি সবুজ সাথী, আপনার গাছের যত্নের AI সহায়ক! দেখা করে ভালো লাগছে! 😊",
        "আমার নাম সবুজ সাথী! আপনার গাছের যত্নে সাহায্য করতে এখানে আছি! 👋",
      ...
      'who are you': [
        "আমি সবুজ সাথী, আপনার গাছের যত্নের AI সহায়ক! 😊",
        "আমি সবুজ সাথী! গাছের যত্নে সাহায্য করতে এখানে আছি! 👋",
        "আমি সবুজ সাথী, গাছের রোগ নির্ণয় এবং যত্নের পরামর্শ দিতে প্রস্তুত! 😄"
      ],
            ...
            if (image) {
              messages.push({
                ...
                content: [
                  {
                    type: "text",
                    text: message || "এই গাছের ছবি বিশ্লেষণ করুন এবং রোগ নির্ণয় করুন এবং যত্নের পরামর্শ দিন"
                  },
                  {
                    type: "image_url",
                    image_url: {
